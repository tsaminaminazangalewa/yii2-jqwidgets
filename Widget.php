...
class Widget extends \yii\base\Widget
{
     ...
     */
    protected function registerPlugin($name,$extjs)
    {
        $view = $this->getView();

        $assetBundle=jqxAsset::register($view);
			$assetBundle->js[]=strtolower($extjs).'.js';
			if(isset($this->clientOptions['theme'])) {
            $themeBundle = jqxThemeAsset::register($view);
            $themeBundle->theme = $this->clientOptions['theme'];
			}
